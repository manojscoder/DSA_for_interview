...
public class sumRange {
    ...
    public void build(int index, int low, int high, int[] arr) {
        ...
        this.segment[index] = this.segment[2 * index + 1] + this.segment[2 * index + 2];
    }
    ...
    public static void main(String[] args) {
        ...
        sumRange DS = new sumRange(arr);
        System.out.println("Total sum in range 3 and 8 is: " + DS.query(0, 0, DS.size - 1, 3, 8));
        System.out.println("Total sum in range 2 and 5 is: " + DS.query(0, 0, DS.size - 1, 2, 5));
        System.out.println("Total sum in range 1 and 9 is: " + DS.query(0, 0, DS.size - 1, 1, 9));
    }
}
